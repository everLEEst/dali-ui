#ifndef DALI_UI_SVG_LOADER_H
#define DALI_UI_SVG_LOADER_H
...
public:
   ...
   */
  SvgRasterizeId Rasterize(SvgLoadId loaderId, uint32_t width, uint32_t height, SvgLoaderObserver* svgObserver,
