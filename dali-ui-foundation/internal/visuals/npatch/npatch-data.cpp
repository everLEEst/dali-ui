...
void NPatchData::LoadComplete(bool loadSuccess, TextureInformation textureInformation)
{
  ...
  // (If mLoadingState was LOAD_COMPLETE, NotifyObserver will be called directly. @todo : Should we fix this logic,
  // matched with texture manager?) So LoadComplete will be called.
