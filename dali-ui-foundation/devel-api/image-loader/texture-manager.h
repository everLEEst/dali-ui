 ...
 * UI keeps the Texture handle until RemoveTexture is called.
 ...
 * UI keeps the TextureSet handle until RemoveTexture is called.
 * @note this method does not check for duplicates,
...
#endif // DALI_UI_DEVEL_API_TEXTURE_MANAGER_H
